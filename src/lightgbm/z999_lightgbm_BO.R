...
hs <- makeParamSet( 
  ...
  makeNumericParam("feature_fraction", lower=  0.2  , upper=    0.85),
  makeIntegerParam("min_data_in_leaf", lower=  2000    , upper= 8000),
  makeIntegerParam("max_depth",        lower=  5    , upper= 30),
  makeIntegerParam("num_leaves",       lower= 16L   , upper= 1024L),
  makeNumericParam("min_gain_to_split",lower= 0.05   , upper= 0.2),
  makeIntegerParam("max_bin",          lower= 20   , upper= 100),
...
dir.create( "./exp/HT9999/", showWarnings = FALSE )
setwd("./exp/HT9999/")   #Establezco el Working Directory DEL EXPERIMENTO


#en estos archivos quedan los resultados
kbayesiana  <- "HT99991.RDATA"
klog        <- "HT99991.txt"
...
# pero nosotros  NO nos vamos a quedar tranquilos sin cuestionar los hiperparametros originales
>>>>>>> ac0462e54f22e418cdfb4b83731b20116e3c1fb3
