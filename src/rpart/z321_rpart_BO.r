...
ksemilla_azar  <- 128339  #cambiar por la primer semilla
...
setwd("C:/Users/rvozzi/OneDrive - genommalabinternacional/Documentos/ECD/DataMining/labo/exp/HT3210/")   #Establezco el Working Directory DEL EXPERIMENTO
